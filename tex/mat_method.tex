...
\paragraph{\textnormal{\texttt{StateEstimator}} (7 subtypes)} -- Open loop and closed-loop state observers, either based on deterministic or stochastic systems. They produce the full state feedback for the \texttt{PredictiveController}.
