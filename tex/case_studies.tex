...
\begin{figure}[h]
    ...
    \caption{CSTR closed-loop simulation\deleted{: $y_1=y_L$, $y_2=y_T$, $u_1=u_c$, and $u_2=u_h$}.}
...
\begin{figure}[h]
    ...
    \caption{CSTR closed-loop simulation with feedforward\deleted{: $y_1=y_L$, $y_2=y_T$, $u_1=u_c$, and $u_2=u_h$}.}
...
\begin{figure}[h]
    ...
    \caption{Pendulum output setpoint tracking\deleted{: $y_1 = \theta$ in \si{\degree} and $u_1 = \tau$ in \si{\newton\meter}.}}
...
\begin{figure}[h]
    ...
    \caption{Pendulum output disturbance rejection\deleted{: $y_1 = \theta$ in \si{\degree} and $u_1 = \tau$ in \si{\newton\meter}}.}
