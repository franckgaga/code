...
See the package documentation\footnote{\texttt{https://franckgaga.github.io/ModelPredictiveControl.jl/stable/}} for more advanced examples like an economic MPC of the pendulum.
