...
See the package documentation\footnote{\texttt{https://franckgaga.github.io/ModelPredictiveControl.jl/stable/}} for more examples like economic MPC of the pendulum.
