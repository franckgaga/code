...
\replaced{The next section presents an econimic predictive control on the pendulum.}{See the package documentation for more advanced examples like economic MPC of the pendulum.}

\comment{The following section is new.}
...
\comment{I could also add the sequential linearization MPC example of \href{http://www.overleaf.com}{Something Linky}}