...
\comment{Should I also include the successive linearization MPC example of \texttt{https://tinyurl.com/493ckw2f} ? Its benchmark would certainly standout in Table 1. There is however no direct equivalent in MATLAB since there is no automatic differentiation. I would need to analytically compute the Jacobian of}
