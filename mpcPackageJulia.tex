...
\usepackage[
    %finalizecache, %no longer supported in minted 3.0 (this, this line needs TexLive 2023)
    %frozencache,
...
\newcommand*{\spacerepl}{\vspace{-2\baselineskip}}
...
\DeclareUnicodeCharacter{1E8B}{dx} 
