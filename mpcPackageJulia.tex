...
\usepackage{amsmath,amssymb,mathtools,textgreek,siunitx,etoolbox} 
...
\newcommand*{\spacerepl}{\vspace*{-8pt}}
%\BeforeBeginEnvironment{minted}{\vspace*{-\baselineskip}}
%\AfterEndEnvironment{minted}{\vspace*{-\baselineskip}}
% ------------------- unicode char handling --------------------------------
\DeclareUnicodeCharacter{0302}{\^{x}} % replace hat by xhat
\DeclareUnicodeCharacter{1D569}{} % hide the blackboard font x
\DeclareUnicodeCharacter{1E8B}{\.{x}} 
\DeclareUnicodeCharacter{03F5}{\textepsilon}
