...
\begin{keyword}
Model Predictive Control; \added{Advanced Process Control}; \replaced[comment={more precise keywords, no longer restricted to ADCHEM 2024 selection}]{State Estimation}{Estimation and Robust Estimation}; \added{Kalman Filter}; \added{Julia Programming Language};
\end{keyword}
